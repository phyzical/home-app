const validationInit = (customVuelidationConfig = {}) => {
    ...
    Vue().then(VuePromise => {
        ...
        vuelidate().then(vuelidatePromise => VueClass.use(vuelidatePromise.default))
        ...
        const customMessages = Object.prototype.hasOwnProperty.call(customVuelidationConfig, 'messages') ? customVuelidationConfig.messages : {}
        const customAttributes = Object.prototype.hasOwnProperty.call(customVuelidationConfig, 'attributes') ? customVuelidationConfig.attributes : {}
