    ...
    computed:{
        message() {
            ...
            case true:
                ...
                break;
            case false:
                message = (this.appNameForDisplay ? `${this.appNameForDisplay} is currently` : 'Currently') + ' down for maintenance. Please check back shortly';
                break;
            default:
                message = this.appNameForDisplay ? `${this.appNameForDisplay} is loading` : 'Loading';
                break;
            }
