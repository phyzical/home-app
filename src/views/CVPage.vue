        ...
        <div class="content">
            ...
            >
                ...
                >
                    ...
                    <div
                        class="cv-entry uk-align-center"
                    >
                ...
                >
                    ...
                    <div
                        class="uk-width-1-1 cv-entry uk-flex uk-flex-column"
                    >
                        <ul>
                            <div
                ...
                >
                    ...
                    >
                        ...
                        >
                        <div
                            class="uk-flex uk-flex-column uk-card-header"
                        >
                            <div
...
export default {
    ...
    methods: {
        ...
        clickDownloadPDF() {
            ...
            setTimeout(() => {
                this.downloadPDF();
                setTimeout(() => {this.isLoading(-1)},1000)
            },1)
        },
        downloadPDF() {
            ...
            const educationHistory = this.cv.educationHistory
                .map(item => [
                    {
                        image: item.image.base64,
                        width: 50,
            ...
            const shortCourses = this.cv.shortCourses.map(item => this.stripHtml(item));
            const additionalSkills = this.cv.additionalSkills.map(item => this.stripHtml(item));
            const references = this.cv.references
                .map(item => [
                    {
                        image: item.image.base64,
                        width: 50,
            ...
            const hobbiesAndInterests = this.cv.hobbiesAndInterests.map(item => this.stripHtml(item));
            const hr = {
            ...
            pdfMake().then(pdfMakePromise => {
                pdfMakePromise.createPdf(docDefinition).download('Jack Carpenter CV.pdf');
            });
        }
    }
}
