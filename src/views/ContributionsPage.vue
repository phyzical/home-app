        ...
        <div class="content">
            ...
            >
                <projects-component
                    ...
                    :class="[displays.agworld ? 'uk-animation-slide-top' :'uk-hidden', 'employed']"
                />
                <projects-component
                    class="simplisite"
                    :projects="projects.simplisite"
                    :class="[displays.simplisite ? 'uk-animation-slide-top' :'uk-hidden', 'employed']"
                />
                <projects-component
                    class="strange-animals"
                    :projects="projects.strangeAnimals"
                    :class="[displays.strangeAnimals ? 'uk-animation-slide-top' :'uk-hidden','employed']"
                />
                <projects-component
                    class="personal"
        ...
        return {
            ...
            projects: {
                agworld: [
                    {
                        title: 'Agworld',
                        image: agworld,
                        body:   '<p>Agworld has a series of codebases behind a paywall</p>' +
                ...
                simplisite: [
                    {
                        title: 'Simplisite',
                        image: simplisite,
                        body:   '<p>This was the main website for Simplisite</p>' +
                    ...
                    },
                    {
                        title: 'Kailis Bros',
                        image: kalisbros,
                        body:   '<p>This was Kailis Bros website by Simplisite</p>' +
                        ...
                        title: 'Cult Status',
                        image: cultstatus,
                        body:   '<p>This is a Shopify website for Cultstatus by Simplisite</p>' +
                        ...
                        title: 'NFIB',
                        image: nfib,
                        body:   '<p>This is a insurance portal built for National Franchisee Insurance Brokers by Simplisite</p>' +
                        ...
                        title: 'Wangle',
                        image: wangle,
                        body:   '<p>This was a website built for wangle by Simplisite</p>' +
                        ...
                        image: nlv,
                        body:   '<p>This was a website built for National Lifestyle Village by Simplisite</p>' +
                        ...
                        title: 'Hawaiian',
                        image: hawaiian,
                        body:   '<p>This was a website built for Hawaiian to maintain the corporate side of the company by Simplisite</p>' +
                        ...
                        title: 'Blackswan',
                        image: blackswan,
                        body:   '<p>This was a website built for Blackswan State Theatre Company by Simplisite</p>' +
                        ...
                        image: cbc,
                        body:   '<p>This was a website built for Cable Beach Club by Simplisite</p>' +
                ...
                strangeAnimals: [{
                    ...
                    image: simonds,
                    body:   '<p>This is a website maintained by StrangeAnimals</p>' +
                    ...
                    image: xpress,
                    body:   '<p>This is a website built for Simonds by StrangeAnimals</p>' +
                    ...
                    image: simonds,
                    body:   '<p>This is a native ios and android app built for Simonds by StrangeAnimals</p>' +
                    ...
                    title: 'Hawaiian',
                    image: hawaiian,
                    body:   '<p>This is a website built for Hawaiian by StrangeAnimals</p>' +
                        '<p>Hawaiian owns a series of shopping centers around Perth</p>' +
                    ...
                    body:   '<p>This is a website built for StrangeAnimals by StrangeAnimals</p>' +
                    ...
                    title: 'Blackswan',
                    image: blackswan,
                    body:   '<p>This is a website built for Blackswan State Theatre Company by StrangeAnimals</p>' +
                        '<p>Blackswan is a theatre company that hosts 6 - 7 unique shows a year</p>' +
                        '<p>This is a CMS running Silverstripe which uses php with webpack, scss and js for the frontend</p>' +
                    ...
                    image: pch,
                    body:   '<p>This is a website built for Perth Concert Hall by StrangeAnimals</p>' +
                    ...
                    image: waso,
                    body:   '<p>This is a website built for West Australian Symphony Orchestra by StrangeAnimals</p>' +
                    ...
                    image: cccsf,
                    body:   '<p>This is a website built for Constable Care\'s Child Safety Foundation by StrangeAnimals</p>' +
                    ...
                    image: bgc,
                    body:   '<p>This is a website built for BGC Contracting by StrangeAnimals</p>' +
                    ...
                    title: 'HomegroupWA',
                    image: hgwa,
                    body:   '<p>This is a website built for HomegroupWA by StrangeAnimals</p>' +
                    ...
                    title: 'Cable Beach Club',
                    image: cbc,
                    body:   '<p>This is a website built for Cable Beach Club by StrangeAnimals</p>' +
                        '<p>Cable Beach Club is a holiday resort in Broome</p>' +
                        '<p>This is a CMS running CraftCMS which uses php with webpack, scss and js for the frontend</p>' +
                    ...
                    title: 'Smartbet',
                    image: smartbet,
                    body:   '<p>This is a website and native app built for Smartbet by StrangeAnimals</p>' +
                    ...
                    image: ect,
                    body:   '<p>This is a website built for Elite Cricket Training by StrangeAnimals</p>' +
                    ...
                    body:   '<p>This is a website built for Adventure World by StrangeAnimals</p>' +
                    ...
                    title: 'YourCall',
                    image: yourcall,
                    body:   '<p>This is a website built for Constable Care by StrangeAnimals</p>' +
                    ...
                    image: suelewis,
                    body:   '<p>This is a website built for Sue Lewis Chocolatier by StrangeAnimals</p>' +
                    ...
                    title: 'Blue Body',
                    image: bluebody,
                    body:   '<p>This is a website built for Blue Body by StrangeAnimals</p>' +
                    ...
                    body:   '<p>This is a website built for Hope For Children by StrangeAnimals</p>' +
